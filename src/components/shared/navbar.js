                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><Link to="/CreateConfiguration"><a className="dropdown-item">New Configurations</a></Link></li>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><Link to="/CreateItem"><a className="dropdown-item">New Items</a></Link></li>
                                <li><hr className="dropdown-divider"></hr></li>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><Link to="/CreateComponent"><a className="dropdown-item">New Components</a></Link></li>
                            </ul>
                        </li>
                    </ul>
                </div>
